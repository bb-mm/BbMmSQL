...
RC SM_Manager::SetUpRelCatAttributes(DataAttrInfo *attributes){
  ...
  memcpy(attributes[0].attrName, "TableName", MAXNAME + 1);
  memcpy(attributes[1].attrName, "RecordLength", MAXNAME + 1);
  memcpy(attributes[2].attrName, "Count", MAXNAME + 1);
...
RC SM_Manager::SetUpAttrCatAttributes(DataAttrInfo *attributes){
  ...
  memcpy(attributes[0].attrName, "Table", MAXNAME + 1);
  memcpy(attributes[1].attrName, "Field", MAXNAME + 1);
  memcpy(attributes[2].attrName, "Offset", MAXNAME + 1);
  memcpy(attributes[3].attrName, "Type", MAXNAME + 1);
  memcpy(attributes[4].attrName, "Length", MAXNAME + 1);
